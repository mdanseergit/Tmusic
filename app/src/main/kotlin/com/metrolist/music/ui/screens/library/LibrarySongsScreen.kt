        ...
        LazyColumn(
            ...
            item(
                ...
                LibrarySearchHeader(
                    ...
                    if (filter == SongFilter.LIKED && filteredSongs.isNotEmpty()) {
                        IconButton(
                            onClick = { filteredSongs.forEach { downloadUtil.download(it) } },
                            modifier = Modifier.padding(start = 8.dp).size(40.dp),
                        ) {
                            Icon(
                                painter = painterResource(R.drawable.download),
                                contentDescription = stringResource(R.string.download_all_favorites),
                            )
                        }
                    }
